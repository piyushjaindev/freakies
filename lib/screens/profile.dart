...
//              ),
                Padding(
                  padding: EdgeInsets.only(
                      ...
                      left: SizeConfig.mainWidth * 0.22,
                      bottom: 0.0,
                      right: 0.0),
                  child: Container(
                    margin: EdgeInsets.all(0.0),
                    width: SizeConfig.mainWidth * 0.60,
                    height: SizeConfig.mainHeight * 0.35,
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(10.0),
                        color: Colors.white, //Colors.white.withOpacity(0.7),
                        boxShadow: [
                          BoxShadow(
                              color: Color(0xFF605856).withOpacity(0.3),
                              spreadRadius: 2.0,
                              blurRadius: 2.0),
                        ]),
                    child: Padding(
                ...
                Padding(
                  padding: EdgeInsets.only(
                      left: SizeConfig.mainWidth * 0.10,
                ...
                currentUser.id == user.id ||
                    ...
                    : Padding(
                        padding: EdgeInsets.only(
                            ...
                            left: SizeConfig.mainWidth * 0.74),
                        child: RawMaterialButton(
                          ...
                          onPressed: user.updateFollow(currentUser.id),
                        ),
                      ),
              ],
            ),
            FittedBox(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: Colors.white,
                  //boxShadow: [BoxShadow(color: Color(0xFF605856),spreadRadius: 2.0,blurRadius: 8.0),]
                ),
